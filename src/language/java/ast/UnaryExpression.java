...
extends Expression
{
    ...
    {
	map.put("Operator", new TreeNode.AttributeMetaData(Integer.TYPE, false, new Integer(0), "The operator that proceeds the expression."));
    }
    ...
    public static final String LABEL = "unary";
    ...
    public UnaryExpression(Expression e, int op)
    {
	setExpression(e);
	m_op = op;
    }
    ...
    public void accept(ASTTraverser v)
    {
	v.visit(this);
    }
